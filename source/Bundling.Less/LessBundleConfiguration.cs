...
{
    public static class LessBundleConfiguration
    {
        ...
        public class Helper : IConfigurationHelper
        {
            ...
            private readonly LessCompileTransform _compileTransform;
            ...
            {
                return itemTransforms.ModifyIf(itemTransforms == null || !itemTransforms.Any(t => t is LessCompileTransform),
                    l =>
                    {
        ...
        public class ExtensionMapper : IExtensionMapper
        {
            ...
            {
                return ".less".Equals(extension, StringComparison.OrdinalIgnoreCase) ? _options : null;
            }
